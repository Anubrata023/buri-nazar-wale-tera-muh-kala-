      ...
      <header className="bg-white border-b border-zinc-200 px-6 py-4 flex justify-between items-center sticky top-0 z-50 shadow-sm">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-xs font-bold text-zinc-400 bg-zinc-50 border border-zinc-200 px-3 py-1.5 rounded-full shadow-inner">
            <button onClick={() => { localStorage.removeItem('userRole'); navigate('/'); }} className="hover:text-slate-800 transition-colors cursor-pointer">Landing</button>
            <span>•</span>
            <button onClick={() => { localStorage.setItem('userRole','admin'); localStorage.setItem('username','admin'); navigate('/admin'); }} className="hover:text-slate-800 transition-colors cursor-pointer">Admin</button>
            <span>•</span>
